...
function checkInputs() {
    var count = 21;
    const form = document.getElementById('form_modifica_immobile');
    ...
    if(titoloImmobileValue === '') {
        setErrorFor(titoloImmobile, "Titolo immobile non può essere vuoto");
    }
    ...
    else if(isValid(cittaValue)){
        setErrorFor(citta, 'No caratteri speciali');
    }
    else {
        setSuccessFor(citta);
        count--;
    ...
    if(numeroCivicoValue === '') {
        setErrorFor(numeroCivico, "Numero civico non può essere vuoto");
    }
    else if(!isNumeroCivico(numeroCivicoValue)){
    ...
    if(capValue === '') {
        ...
        setErrorFor(cap, 'Valore numerico di 5 cifre');
    }
    else {
        setSuccessFor(cap);
        count--;
    ...
    if(zonaValue === '') {
        setErrorFor(zona, "Zona non può essere vuoto");
    }
    else if(isValid(zonaValue)){
    ...
    if(prezzoValue === '') {
        ...
        setErrorFor(prezzo, 'Numeri interi o decimali');
    }
    else {
    ...
    if(superficieValue === '') {
        ...
        setErrorFor(superficie, 'Numeri interi o decimali');
    }
    else {
    ...
    if(classeEnergeticaValue === '') {
        ...
        setErrorFor(classeEnergetica, 'Valore compreso da A a G');
    }
    else {
