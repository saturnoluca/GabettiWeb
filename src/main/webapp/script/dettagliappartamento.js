function show(){
    if(document.getElementById("floor").style.display == "block"){
        $('#floor').slideUp();
        document.getElementById("testo_h3").innerHTML = "Mostra Planimetrie";
    }
    if(document.getElementById("floor").style.display == "none") {
        $('#floor').slideDown();
        document.getElementById("testo_h3").innerHTML = "Nascondi Planimetrie";
    }
}
...
function setErrorFor(input, message) {
    ...
    formControl.className = 'contact_form_row error';
...
function setSuccessFor(input) {
    const formControl = input.parentElement;
    formControl.className = 'contact_form_row success';
}
