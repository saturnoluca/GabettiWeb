...
@WebServlet(name = "RedirectAggiungiUtente", value = "/RedirectAggiungiUtente")
@MultipartConfig
public class RedirectAggiungiUtente extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/aggiungi-utente.jsp");
